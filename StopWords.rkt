#lang racket
(provide removeStopwords)

;Define o diionário de stopwords
...
;;Remove pontuação e separa as palavras por espaço
...
;;Recebe uma frase e retorna a mesma com o split feito e sem pontuação ou stopwords
